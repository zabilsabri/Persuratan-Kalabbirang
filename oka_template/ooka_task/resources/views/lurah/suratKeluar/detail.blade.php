@extends('lurah.layouts.app', ['title' => 'Detail Surat Keluar'])
...
<div class="hal-body">
    ...
    <div class="d-grid gap-5 d-md-flex justify-content-md-center mt-2">
        ...
        <button class="btn btn-success me-md-2 mb-2" type="button" data-bs-toggle="modal" data-bs-target="#modalTandaTangan">
        <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
...
<!-- Modal Tanda Tangan -->
<div class="modal fade" id="modalTandaTangan" tabindex="-1" aria-labelledby="modalTandaTanganLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-4">
                ...
                <div class="modal-body-button text-end">
                    <button type="button" class="btn btn-modal btn-success-modal w-25">Oke</button>
                </div>
            </div>
        </div>
    </div>
