...
<div class="hal-body">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <h6 class="no-surat">Atribut Surat:</h6>
            <table class="table table-borderless">
                <tr>    
                    <td class="surat-kategori" >Nama</td>
                    <td>:</td>
                    <td class="surat-detail" >{{ $surat -> user -> nama }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori" >Tempat / Tgl Lahir</td>
                    <td>:</td>
                    <td class="surat-detail">{{ $surat -> user -> tempat_lahir }}, {{ $surat -> user -> tanggal_lahir }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori"> Jenis Kelamin </td>
                    <td>:</td>
                    <td class="surat-detail">
                        {{ $surat -> user -> jkl }}
                    </td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td class="surat-detail">{{ $surat -> user -> status_nikah }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori" >Agama</td>
                    <td>:</td>
                    <td class="surat-detail">{{ $surat -> user -> agama }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori" >Pekerjaan</td>
                    <td>:</td>
                    <td class="surat-detail">{{ $surat -> user -> pekerjaan }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori" >Alamat</td>
                    <td>:</td>
                    <td class="surat-detail">{{ $surat -> user -> alamat }}</td>
                </tr>
                <tr>
        ...
        <div class="col-sm-6">
            <div class="lampiran">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{ route('surat-keluar-admin.detailFile', [$pengantar -> file_surat]) }}" class="stretched-link">{{ $pengantar -> nama_file_surat }}</a></h5>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <div class="d-grid gap-5 d-md-flex justify-content-md-center mt-2">
        ...
        <a class="btn btn-success mb-2" href="{{ route('surat-keluar.disposisi', [$surat -> id]) }}" role="button">
            <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
...
<div class="modal fade" id="modalDitolakAdmin" tabindex="-1" aria-labelledby="modalDitolakAdminLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body" style="padding-bottom: 0px;">
                ...
                <form action="{{ route('surat-keluar-admin.tolakSurat', [$surat -> id]) }}" method="POST">
                    @csrf
