...
<div class="hal-body">
    <div class="row">
        <h6 class="no-surat">{{ $antar -> suratKeluar -> no_surat }}</h6>
        <div class="col-sm-6">
            <table class="table table-borderless">
                <tr>    
                    <td class="surat-kategori" >Tanggal Surat</td>
                    <td>:</td>
                    <td class="surat-detail" >{{ $antar -> suratKeluar -> tgl_surat }}</td>
                </tr>
                <tr>
                    <td class="surat-kategori"> Dari </td>
                    <td>:</td>
                    <td class="surat-detail">{{ $antar -> suratKeluar -> user -> nama }}</td>
                </tr>
                <tr>
        ...
        <div class="col-sm-6">
            ...
            <div class="lampiran">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{ route('export.surat', ['id' => $antar -> suratKeluar -> id]) }}" class="stretched-link">{{ $antar -> suratKeluar -> jenisSurat -> nama }}.pdf</a></h5>
                    </div>
                </div>
            </div>
    ...
    <form action="{{ route('edit-suratKeluar-antar.process', [$antar -> id]) }}" method="POST">
        @csrf
        <div class="mb-3 row">
