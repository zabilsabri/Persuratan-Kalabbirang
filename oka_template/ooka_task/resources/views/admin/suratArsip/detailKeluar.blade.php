...
<div class="hal-body">
    <div class="row">
        <h6 class="no-surat">{{ $detailArsips -> suratKeluar -> no_surat }}</h6>
        <div class="col-sm-6">
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td class="surat-detail">
                        {{ $detailArsips -> suratKeluar -> user -> nama }}
                    </td>
                </tr>
                <tr>
            ...
            @elseif($detailArsips -> suratKeluar -> status == "Biasa")
            <button type="button" class="btn btn-primary mb-5">Biasa</button>
            @elseif($detailArsips -> suratKeluar -> status == "Penting")
            <button type="button" class="btn btn-danger mb-5">Penting</button>
            @elseif($detailArsips -> suratKeluar -> status == "Rahasia")
        ...
        <div class="col-sm-6">
            <div class="lampiran">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><a href="../../surat-keluar/exportData/{{ $detailArsips -> id }}" class="stretched-link">{{ $detailArsips -> suratKeluar -> jenisSurat -> nama }}</a></h5>
                    </div>
                </div>
            </div>
