    ...
    <div class="col-sm-6">
        <div class="mb-3">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="number" class="form-control" value="00000000000000000000" placeholder="00000000000000000000" aria-label="Username" aria-describedby="addon-wrapping" style="border-left-width: 0px;" disabled readonly>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        <div class="mb-3">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" value="Lorem Ipsum Dolor" placeholder="Lorem Ipsum Dolor" aria-label="Username" aria-describedby="addon-wrapping" style="border-left-width: 0px;" disabled readonly>
            </div>
        </div>
    </div>
