        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                ...
                <div class="modal-body-button text-end">
                    <a href="{{ route('surat-masuk-kasi.ttd', [$surat -> id]) }}" onclick="ttd()" type="button" class="btn btn-modal btn-success-modal w-25">Oke</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-4">
                ...
                <div class="modal-body-button text-end">
                    <a href="{{ route('surat-masuk-kasi')}}" type="button" class="btn btn-modal btn-success-modal w-25">Kembali</a>
                </div>
            </div>
        </div>
    </div>
