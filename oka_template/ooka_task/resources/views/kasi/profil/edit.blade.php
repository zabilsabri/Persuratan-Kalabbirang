        ...
        <div class="profil-input">
            <form action="#">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Lorem ipsum dolor sit amet" value="Lorem ipsum dolor sit amet">
                    ...
                    <div class="col-md-12">
                        <div class="password-input d-flex">
                            <div class="form-floating mb-3 w-100">
                                <input type="password" id="password" style=" border-radius:0; border-right-width: 0px; border-top-left-radius: 4px; border-bottom-left-radius: 4px;" class="form-control" id="floatingInput" placeholder="loremipsum" value="loremipsum">
                                <label for="floatingInput" class="profil-input-label">Password</label>
                            </div>
                            <div class="eye flex-shrink-1 mb-3">
                                <button type="button" class="btn btn-link">
                                <svg width="35" height="24" onclick="showHide()" id="toogle" viewBox="0 0 35 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.5 0C9.54545 0 2.75227 4.976 0 12C2.75227 19.024 9.54545 24 17.5 24C25.4545 24 32.2477 19.024 35 12C32.2477 4.976 25.4545 0 17.5 0ZM17.5 20C13.1091 20 9.54545 16.416 9.54545 12C9.54545 7.584 13.1091 4 17.5 4C21.8909 4 25.4545 7.584 25.4545 12C25.4545 16.416 21.8909 20 17.5 20ZM17.5 7.2C14.8591 7.2 12.7273 9.344 12.7273 12C12.7273 14.656 14.8591 16.8 17.5 16.8C20.1409 16.8 22.2727 14.656 22.2727 12C22.2727 9.344 20.1409 7.2 17.5 7.2Z" fill="#4FB96E"/>
                                </svg>
                                </button>
                            </div>
                        </div>
