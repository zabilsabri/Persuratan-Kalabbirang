<div class="main-sidebar sidebar-style-2">
   <aside id="sidebar-wrapper">
       ...
       <ul class="sidebar-menu">
            ...
            <li class="{{ Route::is('dashboard-kasi') ? 'active' : '' }}" ><a class="nav-link" href="{{ route('dashboard-kasi') }}"><i class="far fa-square"></i> <span>Dashboard</span></a></li>
            <li class="nav-item dropdown {{ Route::is('surat-masuk-kasi') || Route::is('surat-keluar-kasi') || Route::is('surat-arsip-kasi') || Route::is('surat-antar') ? 'active' : '' }}">
               <a href="#" class="nav-link has-dropdown"><i
                       class="fas fa-th-large"></i><span>Surat</span></a>
               <ul class="dropdown-menu">
                   <li class="{{ Route::is('surat-masuk-kasi') ? 'active' : '' }}" >
                        <a class="nav-link" href="{{ route('surat-masuk-kasi') }} "> 
                            ...
                            </svg> <span class="ms-2">Surat</span>
                        </a>
                   </li> 
                   <li class="{{ Route::is('surat-arsip-kasi') ? 'active' : '' }}" >
                        <a class="nav-link" href="{{ route('surat-arsip-kasi') }}"> 
