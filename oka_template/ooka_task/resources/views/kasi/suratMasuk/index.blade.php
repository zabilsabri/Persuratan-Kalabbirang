                    ...
                    <tbody>
                        @foreach($surat_masuks as $index => $surat_masuk)
                            <tr>
                                ...
                                <td scope="col"><a class="btn btn-success" href="{{ route('surat-masuk-kasi.detail', [$surat_masuk -> id]) }}" role="button">Open</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                    ...
                    <tbody>
                        @foreach($surats as $index => $surat)
                            <tr>
                                ...
                                <td scope="col"><a class="btn btn-success" href="{{ route('surat-keluar-kasi.detail', [$surat -> id]) }}" role="button">Open</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
